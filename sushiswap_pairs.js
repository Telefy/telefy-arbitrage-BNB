...
const initOld = async () => {
    const token0 = new sushiSdk.Token(sushiSdk.ChainId.BSC, '0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c', 18) //ARMOR
    const token1 = new sushiSdk.Token(sushiSdk.ChainId.BSC, '0xf16e81dce15b08f326220742020379b855b87df9', 18) //DAI
    ...
    const pair12 = new sushiSdk.Pair(
        sushiSdk.CurrencyAmount.fromRawAmount(token0,'1869151355551998526910'),
        sushiSdk.CurrencyAmount.fromRawAmount(token1,'41474808337628973589631')
      )

      // let inputValueTwo  = trade.outputAmount.toSignificant(6) * 10 ** 18;
      // let inputValueTwo  = 1000 * 10 ** 18;
// console.log(inputValueTwo)
   const trade1 =  new sushiSdk.Trade(
        new sushiSdk.Route([pair12], token0,token1),
        sushiSdk.CurrencyAmount.fromRawAmount(token0,"1000000000000000000000"),
        sushiSdk.TradeType.EXACT_INPUT
      )
